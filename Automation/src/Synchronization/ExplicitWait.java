...
public class ExplicitWait {
	...
	public static void main(String[] args) {
		...
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(60)); // to declared implicit wait
		WebDriverWait wait = new WebDriverWait(driver,Duration.ofSeconds(10)); // to declared Explicit Wait
		driver.get("https://www.shoppersstack.com/"); // launch the WebApplication
